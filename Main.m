...
%dfC_cv = depth_from_correspondences_msc(EIs, refocused_central_img, window_size, alpha_DFC, dmin, dmax, matte, gamma_DFD_s1, gamma_DFD_s2, priorsmap, use_fail_pred);

% 6b) smooth the cost volume
%dfC_cv_smoothed = superpixels_contribution(dfC_cv, superpixels, refocused_central_img, matte);
%DFC = dfC_cv + beta_DFC.*dfC_cv_smoothed;
