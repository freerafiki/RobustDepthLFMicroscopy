function [cvMS, cvMSGF, cvMSBF] = depth_from_correspondences_v2(EIs, c_img, ws, alpha, d_min, d_max, matte, gamma_s1, gamma_s2)
    ...
    [cvL2, cvR2] = tri_stereo_v2(double(imgL), double(imgC), double(imgR), (d_min), (d_max), (ws), (alpha), 2);
    imgL_s1 = impyramid(imgL, 'reduce');
    imgL_s2 = impyramid(imgL_s1, 'reduce');
    imgC_s1 = impyramid(imgC, 'reduce');
    imgC_s2 = impyramid(imgC_s1, 'reduce');
